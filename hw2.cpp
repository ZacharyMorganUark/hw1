...
void animateTriangle() {
    ...
    } else if (startAnimation && elapsedTime <= animationDuration) {
        // If the mouse button is released, start the animation
        // Move the triangle along the line for a few seconds
